...
from .save_img import save_feature_heatmap
import sys
def build_feature_volume3(feature, batch, D, depth, std, near_far, level, tgt_fea=None, omega_net=None):
    ...
    if tgt_fea is None:
        ...
        for s in range(S):
            ...
            # reweight[reweight<0.2] = 1e-6
            # reweight[reweight>0.8] = 0.8
            # print(reweight.shape)
            # reweight, _ = reweight.max(2)
            ...
            if save_fig:
                ...
                save_feature_heatmap(reweight[0,0,0,...].cpu().numpy(), f"./img/reweight_{s}.png")
        ...
        if save_fig:
            save_feature_heatmap(volume_variance[0,0,0,...].cpu().numpy(), f"./img/volume_variance.png")
            save_feature_heatmap(volume_context[0,0,0,...].cpu().numpy(), f"./img/volume_context.png")
            ...
            # save_feature_heatmap((volume_variance_t - volume_variance)[0,0,4,...].cpu().numpy(), f"./img/volume_variance_c.png")
