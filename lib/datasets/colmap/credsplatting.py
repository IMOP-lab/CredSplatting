...
class Dataset:
    ...
    def build_metas(self):
        if len(self.scenes) == 0:
            ### set your own scenes
            scenes = ['Frames_S1',]
            # scenes = ['Frames_S1', 'Frames_S2', 'Frames_S3', 'Frames_S4', 'Frames_S5', 'Frames_S6',
            #           'Frames_S7', 'Frames_S8', 'Frames_S9', 'Frames_S10', 'Frames_S11', 'Frames_S12',
            #           'Frames_S13', 'Frames_S14', 'Frames_S15',]
        else:
            scenes = self.scenes
        self.scene_infos = {}
        self.metas = []
        ...
        for scene in scenes:
            ...
            render_ids = [j for j in range(img_len//8, img_len, img_len//2)] 
            ...
            for i in render_ids:
                ...
                if self.split == 'train':
                    src_views = [train_ids[i] for i in argsorts[:cfg.credsplatting.train_input_views[1]+1]]
                else:
                    src_views = [train_ids[i] for i in argsorts[:cfg.credsplatting.test_input_views]]
    ...
    def __getitem__(self, index_meta):
        ...
        # print(tar_view)
        # print(scene_info['image_names'][tar_view])
        # print(scene_info['image_names'][src_views[0]])
        # print(tar_ext, tar_ixt)

        # print(src_exts[0],src_ixts[0])
        ...
        # print(near_far, self.scale_factor)
    ...
    def read_image(self, scene, view_idx):
        ...
        # 如果图片有 4 个通道，则只保留前 3 个通道 (RGB)
        if img.shape[2] == 4:  # 检查是否有 4 个通道
