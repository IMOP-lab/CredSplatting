...
data_dir="/home/lab2/2T/CredSplatting/datasets/llff"
dir_ply="credsplatting_pointcloud"
scenes=(fern flower fortress horns leaves orchids room trex)
# scenes=(fern)
iter=2500

# python run.py --type evaluate --cfg_file configs/credsplatting/llff_eval.yaml save_ply True dir_ply $dir_ply
